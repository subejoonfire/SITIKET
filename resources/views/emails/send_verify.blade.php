...
<body>
    <div class="half">
        <div class="blue-section">
            <img src="{{ asset('loginTemplate/images/SI-TIKET.png') }}" alt="Jhonlin Group Logo" class="logo">
            <h3>SELAMAT DATANG</h3>
            <h2>Sistem Informasi</h2>
            <h2>Pelayanan</h2>
            <img src="{{ asset('loginTemplate/images/GCOMPUTER.png') }}" alt="illustration  " class="illustration">
        </div>
