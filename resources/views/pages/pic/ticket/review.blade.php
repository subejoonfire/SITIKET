...
<div class="main-panel">
    <div class="content">
        <div class="page-inner">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ url('pic/followup/action/store/'. $data->id) }}" class="btn btn-primary">Tindak Lanjut</a>
                                </div>
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="{{ url('pic/followup/store/'. $data->id) }}" class="btn btn-primary">Tindak Lanjut</a>
                                </div>
            ...
            @if ($data->status != 'SELESAI' && $type != 'followup')
