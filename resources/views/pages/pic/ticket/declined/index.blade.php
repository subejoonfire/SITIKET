                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ url('pic/ticket/review/declined/'. $item->id)}}" class="btn btn-info btn-lg rounded-pill d-flex align-items-center px-3 py-2" data-original-title="Change Status">
